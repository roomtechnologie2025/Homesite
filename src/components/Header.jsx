...
const Header = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-white/90 dark:bg-gray-900/90 backdrop-blur-md shadow-md" role="banner">
      <nav className="container mx-auto px-4 py-4" aria-label="Main navigation">
        <div className="flex items-center justify-between">
          {/* Logo */}
          <div onClick={() => scrollToSection('home')} className="cursor-pointer" role="button" tabIndex={0} onKeyDown={(e) => e.key === 'Enter' && scrollToSection('home')} aria-label="Go to home">
            <Logo />
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="relative group">
              ...
              <div className="absolute right-0 mt-2 w-20 bg-white dark:bg-gray-800 rounded-md shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200" role="menu">
                {languages.map((lang) => (
                  <button
                    key={lang.code}
        ...
        {/* Mobile Navigation */}
        {isMenuOpen && (
          <div className="md:hidden mt-4 pb-4 border-t border-gray-200 dark:border-gray-700" role="navigation" aria-label="Mobile menu">
